...
model = joblib.load('D:\\Majidh\\Amrita\\Academics\\Sem 5\\Machine Learning Lab with Python\\P\\Using_KNN\\Stock Predictions Model_using_KNN.joblib')

st.header('Stock Market Predictor Using KNN')
...
st.subheader('RMSE(Root Mean Square Error) Encountered by using KNN')
