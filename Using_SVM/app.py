...
model = joblib.load("D:\\Majidh\\Amrita\\Academics\\Sem 5\\Machine Learning Lab with Python\\P\\Using_SVM\\Stock Predictions Model_using_SVM.joblib")

st.header('Stock Market Predictor Using SVM')
...
st.subheader('RMSE(Root Mean Square Error) Encountered by using SVM')
